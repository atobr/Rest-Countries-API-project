...
function Search(props:any){
    ...
    return(
        <form onSubmit={handleSubmit}>
            <div className={`search-div ${localStorage.mode}`}>
                ...
                <input name='search' type='text' id='search' className={localStorage.mode} placeholder='Search for a country...' value={input} onChange={handleChange}/>
            </div>    
        </form>
    )
}
